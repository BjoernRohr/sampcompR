...
![](reference/figures/README-univariate_comparison-1.png)
...
![](reference/figures/README-bivariate_comparison-1.png)
...
`(multi_compare())` is restricted to any model commutable with
[`glm()`](https://rdrr.io/r/stats/glm.html) (without weighting) or
`svyglm()` (when weights are provided). In this example, we want to see
if there are differences between the groups when looking at the
regression of `age`, `father's education`, `mother's education`, and
`IQ` on wage and education.
...
For this comparison, three similar regression models are performed. One
model with either survey and one model with the combined surveys,
including an interaction variable that indicates what survey the
respondents are from. After this, for every coefficient, a similar
...
![](reference/figures/README-ols_models-1.png)
...
![](reference/figures/README-adding_logit_models-1.png)
...
- [`uni_compare()`](https://bjoernrohr.github.io/sampcompR/reference/uni_compare.md)
  can be used to make a univariate comparison and get an object usable
  in the other univariate comparison functions or plot the results
  directly.

- [`plot_uni_compare()`](https://bjoernrohr.github.io/sampcompR/reference/plot_uni_compare.md)
  can be used to plot the results of the
  [`uni_compare()`](https://bjoernrohr.github.io/sampcompR/reference/uni_compare.md)
  function.

- [`uni_compare_table()`](https://bjoernrohr.github.io/sampcompR/reference/uni_compare_table.md)
  can be used to get a table for the results of the
  [`uni_compare()`](https://bjoernrohr.github.io/sampcompR/reference/uni_compare.md)
  function.
...
- [`biv_compare()`](https://bjoernrohr.github.io/sampcompR/reference/biv_compare.md)
  can be used to make a bivariate comparison and get an object usable in
  the other bivariate comparison functions or plot the results directly.
...
- [`multi_compare()`](https://bjoernrohr.github.io/sampcompR/reference/multi_compare.md)
  can be used to make a multivariate comparison and get an object usable
  in the other bivariate comparison functions or plot the results
  directly. It is suitable to compare any glm() model between the data
  frame and the benchmark
...
- [`multi_compare_merge()`](https://bjoernrohr.github.io/sampcompR/reference/multi_compare_merge.md)
  can combine objects of the multi_compare() function, to plot them
  together.

### Miscellaneous Functions

- [`dataequalizer()`](https://bjoernrohr.github.io/sampcompR/reference/dataequalizer.md)
  can be used to reduce one data frame to only columns named similarly
  in another data frame and a list of variables given to the function.

- `descriptive_table` can be used to get a descriptive table for a data
  frame, including weighting.
