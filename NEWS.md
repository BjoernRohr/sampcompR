...
* Fixed a bug in plot_multi_compare where labels where legend was not always correctly printed
* Fixed a bug in plot_multi_compare, where the difference summary in the upper right corner was not always correctly printed for some "variants".
* Fixed a bug where plot_biv_compare where labels where legend was not always correctly printed
