...
sampcompR is still in development and may contain bugs. If you use the package and a bug crosses your way, feel free to contact the Author ([bjoern.rohr\@gesis.org](mailto:bjoern.rohr@gesis.org){.email}).
